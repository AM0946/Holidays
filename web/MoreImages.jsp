    ...
    <body>
        ...
        <div id="addhouse_page">
            <div id="addhouse_page_contents">
                <form action="MoreImagesUpload.jsp?id=<% out.print(request.getParameter("house_id")); %>" method="POST" enctype="multipart/form-data">
                     ...
                     <textarea style="display: none;" id="base64" type="text" name="encoded_img"></textarea>
                      ...
                      <div id="button_content">
                            <div class="button">
                              <button class="rate_button" type="submit" >Add Image</button>
                          </div>  
                       </div>
                </form>    
