...
<html>
    <head>
        ...
        <title>Add your house</title>
    </head>
    <body>
        <h2 id="addhouse_page_title">Complete the form below to add your house</h2>
        <div id="addhouse_page">
            <div id="addhouse_page_contents">
                <form action="AddHouseResult.jsp" method="POST">
                    <label class="text_label">House capacity: </label>
                    <select name="bedroom" id="select_country">
                        <option selected value="1 Bedroom">1 Bedroom</option>
                    ...
                    <label class="text_label">Select country: </label>
                    ...
                    <label class="text_label">City/Town/Village: </label>
                    <input class="input_style" type="text" name="city" />

                    <br/><br/>

                    <label class="text_label">Availability: </label>

                    <input class="select_date" type="date" name="from"/> 
                    <span style="font-size:15px; margin-left: 20px;"> to </span>
                    <input class="select_date" type="date" name="to"/>
                    ...
                    <textarea name="description" class="textarea_style" type="description"></textarea>
                                      
                    <br/><br/>
                    
                    <div id="button_content">
                        <div class="button">
                            <button class="rate_button" type="submit">Next</button>
                        </div>  
                    </div>
                </form>    
