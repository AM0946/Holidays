...
<html>
    ...
    <body>
         <h2 id="addhouse_page_title">Search with advanced criteria</h2>
        <div id="addhouse_page">
            <div id="addhouse_page_contents">
                <form action="AdvancedSearchResult.jsp" method="GET">
                    ...
                    <div id="button_content">
                        <div class="button">
                            <button class="rate_button" type="submit">Search</button>
                        </div>  
                    </div>
                </form>    
